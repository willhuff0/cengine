...
layout (location = 1) uniform int u_sampleCount;
layout (location = 2) uniform int u_width;
layout (location = 3) uniform float u_lodBias;
layout (location = 4) uniform int u_distribution; // enum
layout (location = 5) uniform int u_currentFace;
layout (location = 6) uniform int u_isGeneratingLUT; // bool
